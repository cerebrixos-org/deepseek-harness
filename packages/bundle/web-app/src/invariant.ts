/**
 * Package-owned invariant companion for `@cerebrixos/superharness-web-app`.
 * @module @cerebrixos/superharness-web-app/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@cerebrixos/superharness-web-app'
