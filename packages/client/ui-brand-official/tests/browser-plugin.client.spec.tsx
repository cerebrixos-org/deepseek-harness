...
describe('official browser-brand plugin', () => {
  ...
  it('renders the official name independently from both requested mark sizes', () => {
    ...
    expect(name.getByLabelText('Hyperlake SuperHarness').textContent).toBe('HyperlakeSUPERHARNESS')
    ...
    expect(mark.container.querySelector('img')?.getAttribute('src')).toBe('/hyperlake-logo.png')
