...
export const en = {
  ...
  onboardingDescription: 'Choose a supported provider and securely add its API key.',
  onboardingNoModels: 'The provider was connected but returned no available models.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingTitle: '连接模型提供方',
  onboardingDescription: '选择受支持的提供方并安全添加其 API 密钥。',
  onboardingNoModels: '提供方已连接，但没有返回可用模型。',
