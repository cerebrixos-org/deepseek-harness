/** Package invariant companion for the Databricks adapter. @module @cerebrixos/superharness-adapter-databricks/invariant */
...
export const apply = (ctx: Context): Promise<() => void> =>
  Promise.resolve(ctx.invariants.register('@cerebrixos/superharness-adapter-databricks', install))
