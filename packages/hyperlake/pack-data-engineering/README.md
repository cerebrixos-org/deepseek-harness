...
The pack declares a governed data-environment slot. Transformation projects, definition repositories, and workflow orchestrators are optional bindings, so a customer can use the Hyperlake-provisioned capability alone or connect supported tools. It contains no credentials or concrete customer resource ids.
