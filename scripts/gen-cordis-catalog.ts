...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CapabilityAssetAttachRequest: 'capability asset contract is owned by packages/hyperlake/packs/README.md',
  CapabilityAssetRemoveRequest: 'capability asset contract is owned by packages/hyperlake/packs/README.md',
  ...
  CapabilityOutcomesSetRequest: 'capability outcome contract is owned by packages/hyperlake/packs/README.md',
  CapabilityProviderAttachment: 'capability tool-composition contract is owned by packages/hyperlake/packs/README.md',
  CapabilityResourceRemoveRequest: 'capability resource contract is owned by packages/hyperlake/packs/README.md',
  CapabilityResourceUpsertRequest: 'capability resource contract is owned by packages/hyperlake/packs/README.md',
  ...
  PackSelectionRequest: 'capability session-selection contract is owned by packages/hyperlake/packs/README.md',
  PackSessionSelection: 'capability session-selection contract is owned by packages/hyperlake/packs/README.md',
  ...
  PluginInstallRequest: 'profile plugin lifecycle contract is owned by packages/hyperlake/packs/README.md',
  PluginOperationResult: 'profile plugin lifecycle contract is owned by packages/hyperlake/packs/README.md',
  PluginRemoveRequest: 'profile plugin lifecycle contract is owned by packages/hyperlake/packs/README.md',
  PluginResourceDiscoverRequest: 'plugin resource discovery contract is owned by packages/hyperlake/packs/README.md',
  PluginResourceProvider: 'plugin resource discovery contract is owned by packages/hyperlake/packs/README.md',
  PluginResourceView: 'plugin resource discovery contract is owned by packages/hyperlake/packs/README.md',
